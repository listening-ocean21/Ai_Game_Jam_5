...
{
    // Usage:
    // var tutorial = new Tutorial<TutorialMessage>("tutorial");
    // tutorial.onShow += message =>
    // {
    //     Debug.Log($"Tutorial message shown: {message.Name}");
    // };
    //
    // tutorial.Show(TutorialMessage.Appearer);
    // tutorial.Show(TutorialMessage.Pulsater);
    //
    // if (tutorial.IsSeen(TutorialMessage.Appearer))
    // {
    //     Debug.Log("Appearer tutorial seen");
    // }
